...
document.addEventListener('DOMContentLoaded', function() {
    ...
    radioButtons.forEach(radio => {
        radio.addEventListener('change', function() {
            ...
            // Se for 'juridica', permanece na página cadastro-empresa.html
        });
    ...
    const informacoesAdicionaisTextarea = document.getElementById('informacoesAdicionais');

    if (informacoesAdicionaisTextarea) {
        ...
        informacoesAdicionaisTextarea.addEventListener('input', autoResizeTextarea);

        // Call on page load in case there's initial content
        autoResizeTextarea.call(informacoesAdicionaisTextarea);
    }
});
