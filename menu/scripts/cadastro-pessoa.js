...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // === TIPO RADIO BUTTONS (Fallback para navegadores sem suporte a :has()) ===
    const tipoRadios = document.querySelectorAll('.tipo-group .radio-input');
    ...
    tipoRadios.forEach(radio => {
        ...
        radio.addEventListener('change', function() {
            // Remover classe active de todos os labels do grupo
            const allLabels = this.closest('.radio-group').querySelectorAll('.radio-label');
