// ========================================
// PRODUTOS E SERVIÇOS - JavaScript
// ========================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (novoCadastroBtn && novoCadastroMenu) {
        ...
        dropdownItems.forEach(item => {
            item.addEventListener('click', function() {
                ...
                } else if (tipoSelecionado === 'Serviço') {
    ...
    subTabs.forEach(tab => {
        tab.addEventListener('click', function(e) {
            ...
            // Only prevent default for hash links (not page navigation)
            if (href && href.startsWith('#')) {
                ...
                // Here you would load different content based on the sub-tab
                console.log('Sub-tab ativo:', this.textContent.trim());
            }
            // For page links (like ./classificacao.html), allow default navigation
        });
    });
